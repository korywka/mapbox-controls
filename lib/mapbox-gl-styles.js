...
var _class = function () {
  ...
  _createClass(_class, [{
    ...
    value: function insertControls() {
      ...
      this.container.style.fontSize = _theme2.default.fontSize;
    ...
    value: function onAdd(map) {
      ...
      this.map.on('styledata', function () {
        [].forEach.call(_this2.container.querySelectorAll('div'), function (div) {
          ...
          div.style.fontWeight = _theme2.default.fontWeight;
        });
        ...
        if (currentStyleIndex !== -1) {
          ...
          currentNode.style.background = _theme2.default.colorSelected;
          currentNode.style.fontWeight = _theme2.default.fontWeightSelected;
        }
      });
